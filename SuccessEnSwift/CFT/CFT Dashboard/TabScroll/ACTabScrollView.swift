...
open class ACTabScrollView: UIView, UIScrollViewDelegate {
    ...
    override open func prepareForInterfaceBuilder() {
        ...
        let tabSectionHeight = self.tabSectionHeight >= 0 ? self.tabSectionHeight : 30
        ...
        if #available(iOS 8.2, *) {
            tabSectionLabel.font = UIFont.boldSystemFont(ofSize: 15.0)
        } else {
            tabSectionLabel.font = UIFont.boldSystemFont(ofSize: 15.0)
        }
        ...
        if #available(iOS 8.2, *) {
            contentSectionLabel.font = UIFont.boldSystemFont(ofSize: 15.0)
        } else {
            contentSectionLabel.font = UIFont.boldSystemFont(ofSize: 15.0)
        }
