...
class ViewAndEditCustomerVC: UIViewController, TLTagsControlDelegate {
    //Personal info
...
extension ViewAndEditCustomerVC {
...
extension ViewAndEditCustomerVC {
    ...
    func pressedSavedChangesBtn(){
        ...
        btnViewAndEdit.setTitle(" Edit Customer ", for: .normal)
...
extension ViewAndEditCustomerVC : UITextFieldDelegate {
...
extension ViewAndEditCustomerVC : UITableViewDelegate, UITableViewDataSource {
