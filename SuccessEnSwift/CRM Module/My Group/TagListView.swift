...
//    }
    ...
    @IBInspectable open dynamic var removeButtonIndex: Int = 10 {
        didSet {
            for tagView in tagViews {
                tagView.removeButton.tag = removeButtonIndex
            }
        }
    }
    ...
    private func createNewTagViewHeader(_ title: String) -> TagView {
        let tagView = TagView(title: title)
        ...
        tagView.paddingX = paddingX
        tagView.paddingY = paddingY
        tagView.textFont = UIFont.systemFont(ofSize: 14.0)
        tagView.removeIconLineWidth = removeIconLineWidth
        tagView.removeButtonIconSize = removeButtonIconSize
        tagView.enableRemoveButton = enableRemoveButton
        tagView.removeIconLineColor = removeIconLineColor
    ...
    open func addTag(_ title: String) -> TagView {
        return addTagView(createNewTagViewHeader(title))
    }
