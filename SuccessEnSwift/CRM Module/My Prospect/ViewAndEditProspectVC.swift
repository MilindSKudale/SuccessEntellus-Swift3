...
class ViewAndEditProspectVC: UIViewController, TLTagsControlDelegate {
...
//            for camp in arrAssignedCamp{
//                vwAssignedCampaign.addTag(camp as! String)
//            }
//        }else{
//            vwAssignedCampaign.addTag("No campaigns assigned yet.")
//            vwAssignedCampaign.viewWithTag(0)
//        }
//        vwAssignedCampaign.mode = .list
//        vwAssignedCampaign.reloadTagSubviews()
    }
...
extension ViewAndEditProspectVC {
...
extension ViewAndEditProspectVC {
    ...
    func pressedSavedChangesBtn(){
        ...
        btnViewAndEdit.setTitle(" Edit Prospect ", for: .normal)
...
extension ViewAndEditProspectVC : UITextFieldDelegate {
...
extension ViewAndEditProspectVC : UITableViewDelegate, UITableViewDataSource {
