...
class AJAutocompletePlaceTextfield: UITextField , UITextFieldDelegate {
    ...
    fileprivate func commonInit(){
        ...
        highLightTypeTextedAttributes = [.foregroundColor : UIColor.black]
        highLightTypeTextedAttributes![.font] = UIFont.boldSystemFont(ofSize: 12)
    ...
    fileprivate func showHighlightedTypedText(aStr : NSString) -> NSAttributedString {
        ...
        let attrs : [NSAttributedStringKey: Any] = [.foregroundColor : autoCompleteTextColor, .font : autoCompleteTextFont] 
...
extension AJAutocompletePlaceTextfield: UITableViewDataSource, UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if autoCompletePlacesData.count > 0 {
