...
@IBDesignable public class TabLayout: UIScrollView, UIScrollViewDelegate{
    ...
    @IBInspectable public var currentTextColor: UIColor = UIColor.white {
        didSet { reload() }
    }
    ...
    @IBInspectable public var currentFont: UIFont = UIFont.boldSystemFont(ofSize: 15) {
        didSet { reload() }
    }
    ...
    private func refreshButtons() {
        ...
        for i in 0..<buttons.count {
            ...
            if (i==index){
                button.backgroundColor = APPGRAYCOLOR;
            }else{
