...
public class UIDropDown: UIControl {
    ...
    public var arrowPadding: CGFloat = 10.0 {
        didSet{
    ...
    fileprivate func setup() {
        ...
        let arrowContainer = UIView(frame: CGRect(x: title.frame.maxX+10,
                                                  y: 0,
        ...
        arrow = Arrow(origin: CGPoint(x: 0,
                                      y: arrowPadding),
...
extension UIDropDown: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if currentDay == options[indexPath.row] {
        ...
        cell!.accessoryType = indexPath.row == selectedIndex ? .none : .none
