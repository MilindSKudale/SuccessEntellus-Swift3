...
class AddTemplateVC :UIViewController, UIImagePickerControllerDelegate, UIDocumentMenuDelegate, UIDocumentPickerDelegate, UINavigationControllerDelegate, URLSessionDelegate, URLSessionTaskDelegate, URLSessionDataDelegate, TagListViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        txtEmailSubject.text = "Follow Up"
...
extension AddTemplateVC : UITextFieldDelegate {
...
extension AddTemplateVC: RichEditorDelegate {
...
extension AddTemplateVC: RichEditorToolbarDelegate {
