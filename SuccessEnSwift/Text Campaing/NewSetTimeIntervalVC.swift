//
//  SetTimeIntervalVC.swift
//  SuccessEnSwift
//
//  Created by Milind Kudale on 03/09/18.
//  Copyright © 2018 milind.kudale. All rights reserved.
//

import UIKit

class NewSetTimeIntervalVC: UIViewController, UITextFieldDelegate {
...
extension NewSetTimeIntervalVC {
        ...
        OBJCOM.modalAPICall(Action: "getTextMessageById", param:dictParamTemp as [String : AnyObject],  vcObject: self) {
            ...
            if success == "true"{
                ...
                if reminderType == "1" {
                    ...
                    self.repeatWeeks = result["txtempRepeatWeeks"] as? String ?? "1"
