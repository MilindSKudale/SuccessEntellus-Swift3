...
public enum RichEditorDefaultOption: RichEditorOption {
    ...
    public static let all: [RichEditorDefaultOption] = [
        .clear, .undo, .redo, .bold, .italic,.underline,
        .textColor, .textBackgroundColor,.image, .link,
        .alignLeft, .alignCenter, .alignRight,
        orderedList, unorderedList,.subscript, .superscript, .strike,
        .indent, outdent, .header(1), .header(2),
        ]
